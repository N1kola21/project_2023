...
public class Knight extends Piece {
    ...
    private static final String WHITE_KNIGHT_IMAGE_PATH = "white_knight.png";
    private static final String BLACK_KNIGHT_IMAGE_PATH = "black_knight.png";


    //získá proměnné z třídy piece
    public Knight(Color color, Square position, String playerName) {
