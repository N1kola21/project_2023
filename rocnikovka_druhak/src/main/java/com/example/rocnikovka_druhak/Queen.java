...
public class Queen extends Piece{
    ...
    private static final String WHITE_ROOK_IMAGE_PATH = "white_queen.png";
    private static final String BLACK_ROOK_IMAGE_PATH = "black_queen.png";


    //získá proměnné z třídy piece
    public Queen(Color color, Square position, String playerName) {
